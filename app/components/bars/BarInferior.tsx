...
import { View, useWindowDimensions, StyleSheet, Button, Pressable } from 'react-native';
        ...
        <View style={[styles.top, {width: width,height: width >= 768 ? 80:50}]}>
            <View style={{width: '100%',display: 'flex',alignItems: 'center', justifyContent:'space-around', flexDirection:'row', height: '100%'}}>
                <Pressable onPress={() => {navigation.navigate('Home')}}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color={routeName === 'Home' ? '#383838' : '#fff'} fill="none">
                ...
                <Pressable style={{cursor:'pointer'}} onPress={()=> navigation.navigate('Tasks')}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#eeeeee" fill="none" transform="rotate(270)">
                ...
                <Pressable style={{cursor:'pointer'}} onPress={()=> navigation.navigate('Tasks')}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#eeeeee" fill="none">
                ...
                <Pressable style={{cursor:'pointer'}} onPress={()=> navigation.navigate('Home')}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#eeeeee" fill="none">
