  ...
  return (
    <View style={[styles.container, { width: width >= 768 ? width * 0.4 : width * 0.9, height: width >= 768 ? height * 0.6 : height * 0.35 }]}>
      <View style={styles.tableHeader}>
        <Text style={[styles.headerCell, { fontSize: width >= 990 ? 20 : 10 }]}>Nome</Text>
        <Text style={[styles.headerCell, { fontSize: width >= 990 ? 20 : 10 }]}>Concluidas</Text>
        <Text style={[styles.headerCell, { fontSize: width >= 990 ? 20 : 10 }]}>Em andamento</Text>
        <Text style={[styles.headerCell, { fontSize: width >= 990 ? 20 : 10 }]}>Não entregue</Text>
      </View>
